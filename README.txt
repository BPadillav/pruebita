...
a persistence unit "pruebaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba/pom.xml":
...
artifact ("prueba.war") is already built. You can build
